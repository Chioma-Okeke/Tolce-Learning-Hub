...
const ProgramSection = ({ icon: Icon, title, items }) => (
    <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
            <Icon size={24} className="text-[#1D976C]" />
...
function ServiceDescription({ package_ }) {
    return (
        <div className="space-y-8">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                    <FiClock size={24} className="text-[#1D976C]" />
                ...
                <div className="pl-9 space-y-3">
                    <div className="flex items-center gap-3">
                        <FiClock size={20} className="text-[#1D976C]" />
                        <span className="text-[#555555]">
                            {package_.structure.duration}
                        </span>
                    </div>
                    <div className="flex items-center gap-3">
                        <FiVideo size={20} className="text-[#1D976C]" />
                        <span className="text-[#555555]">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3">
                            <FiBookOpen size={20} className="text-[#1D976C]" />
